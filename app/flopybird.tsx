...
export default function FlopyBird() {
    ...
    const [obstacleHight, setObstacleHeight] = useState(0);
    ...
    useEffect(() => {
        ...
        if (
            ...
            (birdBottom > obstacleHight + obstacle_gaps &&
                 ...
                 obstacleLeft>bird_Size-obstacle_gaps
    ...
    return (
        ...
        style={[
            styles.obstacle,
            {
                height: height - obstacleHight - obstacle_gaps,
